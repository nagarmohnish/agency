    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Derivative Labs</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-sm">
              Where marketing meets technology. We drive growth through performance
              marketing and build intelligent systems that scale your operations.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Derivative Labs. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
