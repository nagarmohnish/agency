        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20">
          ...
          <div>
            ...
            <p className="text-body-lg text-[var(--text-secondary)] mb-12">
              ...
              on where you&apos;re winning, where you&apos;re invisible to AI, and a
              shortlist of fixes — within 24 hours.
            </p>
            ...
            <div className="glass-card-glow p-8 mb-10">
              ...
              <ul className="space-y-5">
                {[
                  "Audit of paid, search & AI-answer visibility",
                  "Where AI tools currently send buyers",
                  "A prioritized shortlist of fixes",
                  "No retainer pitch on the first call",
                ].map((item) => (
