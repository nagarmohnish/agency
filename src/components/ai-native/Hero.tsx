      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 pt-44 pb-32 lg:pt-52 lg:pb-40">
        <div className="max-w-4xl">
          ...
          <p className="text-body-lg text-[var(--text-secondary)] max-w-xl mb-12">
            We run Meta and Google ads, win visibility <em>inside</em> AI answers,
            and produce the content and creative that feeds both — AI-native
            execution, human judgment, optimized for what hits your bank account,
            not your dashboard.
          </p>
